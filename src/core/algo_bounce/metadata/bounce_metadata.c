...
char *bounce_build_metadata_json(void)
{
    ...
    metadata_add_parameter(parameters, 7, "Starting Angle", BCD_METADATA_PARAM_TYPE_DECIMAL, NULL, 0, "", BCD_METADATA_PARAM_SECTION_COVERAGE_PATH, BCD_METADATA_APP_HANDLER_NONE, 1, 0.0, 1, 360.0, 0);
