...
char *bounce_build_metadata_json(void)
{
    ...
    metadata_add_parameter(parameters, 8, "Max Iterations", METADATA_PARAM_TYPE_INTEGER, NULL, 0, "5000", METADATA_PARAM_SECTION_COVERAGE_PATH, METADATA_APP_HANDLER_NONE, 1, 1.0, 1, 1000000.0, METADATA_UNIT_TYPE_UNITLESS);
    ...
    metadata_add_parameter(parameters, 11, "Coverage Grid Cell Size", METADATA_PARAM_TYPE_DECIMAL, NULL, 0, "5", METADATA_PARAM_SECTION_COVERAGE_PATH, METADATA_APP_HANDLER_NONE, 1, 0.0, 0, 0.0, METADATA_UNIT_TYPE_UOM);
    ...
    metadata_add_parameter(parameters, 13, "Headland Width", METADATA_PARAM_TYPE_DECIMAL, NULL, 0, "4.9", METADATA_PARAM_SECTION_COVERAGE_PATH, METADATA_APP_HANDLER_NONE, 1, 0.0, 0, 0.0, METADATA_UNIT_TYPE_UOM);
