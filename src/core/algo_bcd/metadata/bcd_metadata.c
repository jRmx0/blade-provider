...
char *bcd_build_metadata_json(void)
{
	...
	metadata_add_parameter(parameters, 7, "Headland Width", METADATA_PARAM_TYPE_DECIMAL, NULL, 0, "10", METADATA_PARAM_SECTION_COVERAGE_PATH, METADATA_APP_HANDLER_NONE, 1, 0.0, 0, 0.0, METADATA_UNIT_TYPE_UOM);
	metadata_add_parameter(parameters, 8, "Track Memory Usage", METADATA_PARAM_TYPE_BOOLEAN, NULL, 0, "true", METADATA_PARAM_SECTION_PERFORMANCE, METADATA_APP_HANDLER_NONE, 0, 0.0, 0, 0.0, NULL);
