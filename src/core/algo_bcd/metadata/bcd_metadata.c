...
char *bcd_build_metadata_json(void)
{
	...
	metadata_add_parameter(parameters, 2, "Path Overlap", METADATA_PARAM_TYPE_DECIMAL, NULL, 0, "0", METADATA_PARAM_SECTION_COVERAGE_PATH, METADATA_APP_HANDLER_NONE, 1, 0.0, 0, 0.0, NULL);
	metadata_add_parameter(parameters, 3, "Format", METADATA_PARAM_TYPE_ENUM, format_values, 1, METADATA_FORMAT_POLYGON, METADATA_PARAM_SECTION_ENVIRONMENT, METADATA_APP_HANDLER_ENVIRONMENT_FORMAT, 0, 0.0, 0, 0.0, NULL);
	metadata_add_parameter(parameters, 4, "Type", METADATA_PARAM_TYPE_ENUM, type_values, 1, METADATA_TYPE_OFFLINE, METADATA_PARAM_SECTION_ENVIRONMENT, METADATA_APP_HANDLER_ENVIRONMENT_TYPE, 0, 0.0, 0, 0.0, NULL);
	metadata_add_parameter(parameters, 5, "Coordinate System", METADATA_PARAM_TYPE_ENUM, coordsystem_values, 1, METADATA_COORDSYSTEM_CARTESIAN, METADATA_PARAM_SECTION_ENVIRONMENT, METADATA_APP_HANDLER_ENVIRONMENT_COORDSYSTEM, 0, 0.0, 0, 0.0, NULL);
	metadata_add_parameter(parameters, 6, "Track Memory Usage", METADATA_PARAM_TYPE_BOOLEAN, NULL, 0, "true", METADATA_PARAM_SECTION_PERFORMANCE, METADATA_APP_HANDLER_NONE, 0, 0.0, 0, 0.0, NULL);
	metadata_add_parameter(parameters, 7, "Headland", METADATA_PARAM_TYPE_BOOLEAN, NULL, 0, "true", METADATA_PARAM_SECTION_COVERAGE_PATH, METADATA_APP_HANDLER_NONE, 0, 0.0, 0, 0.0, NULL);
	metadata_add_parameter(parameters, 8, "Headland Width", METADATA_PARAM_TYPE_DECIMAL, NULL, 0, "10", METADATA_PARAM_SECTION_COVERAGE_PATH, METADATA_APP_HANDLER_NONE, 1, 0.0, 0, 0.0, NULL);
