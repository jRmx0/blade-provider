...
char *bcd_build_metadata_json(void)
{
	...
	metadata_add_parameter(parameters, 8, "Headland Width", BCD_METADATA_PARAM_TYPE_DECIMAL, NULL, 0, "10", BCD_METADATA_PARAM_SECTION_COVERAGE_PATH, BCD_METADATA_APP_HANDLER_NONE, 1, 0.0, 0, 0.0, NULL);
